...
const userPreference = 'regular';
let flavourSelection;

flavourSelection = userPreference === 'sugar-free' ? "Sugar-free" : "Regular";
...
const cansLeft = 3; // Any number of cans
let stockCheck; 
...
workoutIntensity = heartRate < 100 ? "Boost Needed" : "Energy levels are high";
...
let temperatureSuitability; 

temperatureSuitability = currentTemp <= 5 ? "Chilled to Perfection" : "Needs a Cooler!"; 
...
let lateNightCodingSessions; 

lateNightCodingSessions = currentHour <= 7 && currentHour < 24 ? "Unleash the Beast" : "Better stick to water";
